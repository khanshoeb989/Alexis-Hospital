...
export default function TopInfoBar() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#0080ff] text-white text-xs sm:text-sm ">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          ...
          <div className="hidden lg:block">
            ...
            >
              <span className="whitespace-nowrap">alexishospitalbhiwandi@gmail.com</span>
            </InfoItem>
          </div>
        ...
        {/* Mobile and Tablet condensed contact info */}
        <div className="flex md:hidden items-center gap-2 sm:gap-3 ">
          <a
            href="tel:+919028111592"
            className="flex items-center gap-1 hover:text-[#E6F0FA] transition text-xs sm:text-sm whitespace-nowrap"
          >
            <Phone size={12} className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
          ...
          <a
            ...
            className="flex items-center gap-1 hover:text-[#E6F0FA] transition text-xs sm:text-sm whitespace-nowrap"
          >
            <Mail size={12} className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 ml-auto">
          ...
          {/* Tablet-only location link */}
          <a
            href="https://maps.google.com"
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:flex md:hidden items-center gap-1 hover:text-[#E6F0FA] transition text-xs sm:text-sm whitespace-nowrap ml-1 sm:ml-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden xl:flex items-center gap-2 hover:text-[#E6F0FA] transition text-sm whitespace-nowrap ml-2"
          >
      ...
      {/* MOBILE QUICK ACTION BAR - Only show on very small screens */}
      <div className="md:hidden border-t border-white/20 bg-[#0D4E92] px-3 py-1.5 flex justify-around">
        <MobileAction href="tel:+919028111592" icon={<Phone size={12} className="w-3.5 h-3.5" />}>
          <span className="text-xs">Call Now</span>
        </MobileAction>
        <MobileAction
          href="mailto:alexishospitalbhiwandi@gmail.com"
          icon={<Mail size={12} className="w-3.5 h-3.5" />}
        >
          <span className="text-xs">Email Us</span>
        </MobileAction>
        <MobileAction
          href="https://maps.google.com"
          icon={<MapPin size={12} className="w-3.5 h-3.5" />}
        >
...
function InfoItem({
  ...
  return (
    <a
      ...
      className="flex items-center gap-1.5 sm:gap-2 hover:text-[#E6F0FA] transition whitespace-nowrap"
    >
      {icon}
